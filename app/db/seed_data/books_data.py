books_data = [
    ...
    {'book_title': 'Mrs. Dalloway', 'page_count': 194, 'publish_date': '1925-05-14', 'price': 7.99, 'short_description': "Details a day in the life of Clarissa Dalloway, a fictional high-society woman in post�First World War England. It is one of Woolf's best-known novels.", 'inventory_count': 87, 'isbn': '9780156628709', 'author_id': 'a41e87a3-ed5a-432b-88e8-ac5d971f1c36', 'book_id': 'cb16b8cd-82b2-4489-9a7f-7e085051a001'},
    ...
    {'book_title': 'Warrior of the Light', 'page_count': 160, 'publish_date': '2003-03-30', 'price': 16.99, 'short_description': 'A manual that teaches the reader, through stories and reflections, how to embrace the warrior of the light within themselves.', 'inventory_count': 36, 'isbn': '9780060527983', 'author_id': '779fa00a-09d6-444e-9ce8-540e65ac5e19', 'book_id': '6e515ee5-0529-4013-ad25-5c3c5f4d79b1'},
    ...
    {'book_title': 'Life on the Mississippi', 'page_count': 624, 'publish_date': '1883-01-01', 'price': 13.95, 'short_description': "A memoir of Twain's experiences as a steamboat pilot on the Mississippi River before the American Civil War, and a travel book, recounting his trip down the Mississippi River from St. Louis to New Orleans many years after the War.", 'inventory_count': 6, 'isbn': '9780486414263', 'author_id': '78f2351f-8786-45f6-8e8e-78d3dc51e9fa', 'book_id': 'ae30fc90-3b04-48b1-b3a9-eedabe83457c'},
    ...
    {'book_title': 'The Death of Ivan Ilyich', 'page_count': 86, 'publish_date': '1886-02-01', 'price': 10.0, 'short_description': 'A novella by Leo Tolstoy, considered one of the masterpieces of his late fiction, written shortly after his religious conversion of the late 1870s.', 'inventory_count': 29, 'isbn': '9780486435091', 'author_id': '19730510-9a97-4ce9-a39d-506bb7ff1a8f', 'book_id': '1b1f18d6-05c6-443d-94bf-c42595b16506'},
    ...
    {'book_title': 'Notes from Underground', 'page_count': 136, 'publish_date': '1864-01-01', 'price': 6.95, 'short_description': "A short and powerful novel that introduces Dostoevsky's most important themes�psychological depth, existential despair, and the quest for meaning in a seemingly indifferent world.", 'inventory_count': 85, 'isbn': '9780486270531', 'author_id': 'cc198234-0a02-4299-bd2f-fdba9edfbbf8', 'book_id': '3a9423c9-5500-468d-ad74-871ce83dc158'},
    ...
    {'book_title': 'As I Lay Dying', 'page_count': 267, 'publish_date': '1930-10-06', 'price': 14.95, 'short_description': "The novel tells the story of the death of Addie Bundren and her poor, rural family's quest and motivations�noble or selfish�to honor her wish to be buried in the town of Jefferson.", 'inventory_count': 50, 'isbn': '9780679732259', 'author_id': '9e668a21-9cd9-4c4f-aa01-76993332fec5', 'book_id': '3744ca10-be97-4822-b661-7c2e8cad5284'},
    ...
    {'book_title': 'Murder on the Orient Express', 'page_count': 256, 'publish_date': '1934-01-01', 'price': 14.99, 'short_description': "A classic mystery novel featuring the Belgian detective Hercule Poirot, who investigates a murder aboard the famous train. Christie's ingenious plot twists will keep you guessing until the very end.", 'inventory_count': 90, 'isbn': '9780062693662', 'author_id': 'f320efd3-ba7d-41ab-bf02-503189318d63', 'book_id': '620cdcdc-1f5b-4822-9612-8d82467e9c20'},
    {'book_title': 'Ulysses', 'page_count': 730, 'publish_date': '1922-02-02', 'price': 23.0, 'short_description': "Joyce's groundbreaking novel chronicles the peripatetic appointments and encounters of Leopold Bloom in Dublin in the course of an ordinary day, 16 June 1904.", 'inventory_count': 70, 'isbn': '9780141182803', 'author_id': 'e510348a-d8bd-4b1d-bcde-a4e8f30aef1d', 'book_id': '7fcf3d23-419c-454b-850f-1c07317caf8c'},
    {'book_title': 'The Trial', 'page_count': 304, 'publish_date': '1925-01-01', 'price': 12.95, 'short_description': "Kafka's nightmarish tale of a man arrested and prosecuted by a remote, inaccessible authority, with the nature of his crime revealed neither to him nor the reader.", 'inventory_count': 80, 'isbn': '9780805209990', 'author_id': 'ab25f66b-2b22-4f27-ac88-5526e2359d4f', 'book_id': 'b837fef5-40fb-474e-ba91-87c717c37544'},
    ...
    {'book_title': 'One Hundred Years of Solitude', 'page_count': 417, 'publish_date': '1967-06-05', 'price': 18.99, 'short_description': "M�rquez's epic tells the story of the Buend�a family over seven generations, blending the magical and the real in a vividly painted Colombian landscape.", 'inventory_count': 95, 'isbn': '9780060883287', 'author_id': 'f3d83e18-6d8d-4e34-a27c-f9a02d26e5ec', 'book_id': 'cdd9ff82-fbbe-4473-9469-4e639ec6eaf5'},
    ...
    {'book_title': 'Harry Potter and the Chamber of Secrets', 'page_count': 341, 'publish_date': '1998-07-02', 'price': 12.99, 'short_description': 'The second installment in the Harry Potter series finds Harry and his friends facing new challenges, including the legend of the Chamber of Secrets.', 'inventory_count': 93, 'isbn': '9780439064873', 'author_id': 'd063d6d6-4fb8-4e3b-9d9a-b8e9a70b2d29', 'book_id': '805bf29a-9afa-4e20-81ab-92c25868a9e2'},
    ...
    {'book_title': 'The Bell Jar', 'page_count': 288, 'publish_date': '1963-01-14', 'price': 17.0, 'short_description': "Plath's semi-autobiographical novel, which details the descent of Esther Greenwood, a young woman moving to New York City, into mental illness.", 'inventory_count': 90, 'isbn': '9780060837020', 'author_id': '7989698a-1c58-400f-9a2c-3b2ce6a07f15', 'book_id': '594a2650-3005-404d-85db-6a2a33040b56'},
    ...
    {'book_title': 'Moby-Dick', 'page_count': 752, 'publish_date': '1851-10-18', 'price': 18.0, 'short_description': "Melville's epic tale of obsession and revenge on the high seas, as Captain Ahab hunts the white whale, Moby-Dick, who maimed him.", 'inventory_count': 85, 'isbn': '9780142437247', 'author_id': 'de777e19-98bd-4da0-af06-653de1c60549', 'book_id': 'aea16536-842b-4108-9d5a-bb0cb5bb8704'},
    ...
    {'book_title': 'The Man in the High Castle', 'page_count': 274, 'publish_date': '1962-01-01', 'price': 13.95, 'short_description': 'An alternate history novel set in a world where the Axis powers won World War II. The story follows several characters living in the 1960s United States, now divided between Japan and Nazi Germany.', 'inventory_count': 65, 'isbn': '9780547572482', 'author_id': '665f841e-75e9-44bb-9cb8-ca78752b4b78', 'book_id': 'a2d912c2-257e-4028-a0ec-9bda804742e5'},
    {'book_title': "The Handmaid's Tale", 'page_count': 311, 'publish_date': '1985-04-01', 'price': 15.95, 'short_description': 'In a dystopian future, where a totalitarian regime enforces subservient roles on all women, Offred navigates the dangers of her reality with strength and cunning.', 'inventory_count': 90, 'isbn': '9780385490818', 'author_id': '876dcb7c-c4ab-4f78-bef2-fb8a00980358', 'book_id': 'eb9a566a-7020-4ef8-b168-3d68aa39d23c'},
    ...
    {'book_title': 'Never Let Me Go', 'page_count': 288, 'publish_date': '2005-04-05', 'price': 16.0, 'short_description': "Ishiguro's haunting story of Kathy, Tommy, and Ruth, and their journey of memories and the truth about their seemingly idyllic school, Hailsham, which hides a dark secret.", 'inventory_count': 88, 'isbn': '9781400078774', 'author_id': '24bad126-0f71-4de7-b639-289fb5fa4c27', 'book_id': 'b8a5caad-d6d7-4f3d-9522-bfcfe0a5f049'},
    ...
    {'book_title': 'The Catcher in the Rye', 'page_count': 234, 'publish_date': '1951-07-16', 'price': 9.99, 'short_description': "Salinger's classic novel of teenage rebellion and angst. The narrative follows Holden Caulfield's experiences in New York City after being expelled from prep school.", 'inventory_count': 85, 'isbn': '9780316769488', 'author_id': '0402bda8-1bba-42dd-8fbe-ed48ddc1d491', 'book_id': '8811f52e-6e18-424d-95d9-954cebd53302'},
    ...
    {'book_title': 'Things Fall Apart', 'page_count': 209, 'publish_date': '1958-06-17', 'price': 12.99, 'short_description': "Chinua Achebe's masterpiece tells the story of Okonkwo, a proud and powerful village leader amongst the Igbo in Nigeria, and the tragic unraveling of his life as a result of colonialism.", 'inventory_count': 80, 'isbn': '9780385474542', 'author_id': 'f968cb73-8eed-4006-9f7f-4ac1ed183aa4', 'book_id': '4de2c275-4077-49d9-9f68-c92621294160'},
    ...
    {'book_title': 'Madame Bovary', 'page_count': 320, 'publish_date': '1856-01-01', 'price': 11.95, 'short_description': "Gustave Flaubert's debut novel is a meticulous depiction of bourgeois triviality and a woman's pursuit of the extraordinary in her life, leading to her eventual downfall.", 'inventory_count': 60, 'isbn': '9780140449129', 'author_id': '14b0d2b0-e758-41e3-a863-59597b951f41', 'book_id': '80c39dff-06b6-489d-8169-bb58b0ba1f8c'},
    ...
    {'book_title': 'The Awakening', 'page_count': 195, 'publish_date': '1899-04-22', 'price': 7.99, 'short_description': "Kate Chopin's novel is a daring exploration of female independence and sexuality. Edna Pontellier's struggle to reconcile her unorthodox views on femininity and motherhood with the prevailing social attitudes of the turn-of-the-century American South is compelling and tragic.", 'inventory_count': 80, 'isbn': '9780486277868', 'author_id': '2d7532d3-6f13-4805-b900-0a934d58c725', 'book_id': 'dcd8068f-afad-476e-9496-be37f63b341d'},
    {'book_title': 'The Cherry Orchard', 'page_count': 96, 'publish_date': '1904-01-17', 'price': 10.0, 'short_description': "Chekhov's last play, a masterpiece of modern drama, portrays the decline of the aristocratic Ranevskaya family and the sale of their estate, including its much-loved cherry orchard.", 'inventory_count': 70, 'isbn': '9780486275482', 'author_id': 'cde3152c-07a3-402a-8324-76ce14975f91', 'book_id': '32ee910b-5b89-4b37-a8ae-8843dba9510d'},
    {'book_title': 'The Age of Innocence', 'page_count': 365, 'publish_date': '1920-09-01', 'price': 14.0, 'short_description': "Wharton's Pulitzer Prize-winning novel captures the hypocrisy and rigidity of New York high society in the late 19th century through the story of Newland Archer's conflicted desires.", 'inventory_count': 80, 'isbn': '9780486298030', 'author_id': 'a49c3520-f9a5-4ec3-8870-903a4de34791', 'book_id': 'aab4e42b-f568-4b36-9625-fcdbcec3151d'},
    ...
    {'book_title': 'The Stranger', 'page_count': 123, 'publish_date': '1942-06-19', 'price': 13.95, 'short_description': "Camus's existential masterpiece tells the story of Meursault, an indifferent French Algerian who commits a random act of violence, reflecting the absurdity of life.", 'inventory_count': 85, 'isbn': '9780679720201', 'author_id': 'd54293d0-48ac-449b-9e99-1b0e198fb629', 'book_id': '4011081b-fe69-48fc-b938-1b4afeb61d0a'},
    ...
    {'book_title': 'On the Road', 'page_count': 310, 'publish_date': '1957-09-05', 'price': 16.0, 'short_description': "Kerouac's seminal novel defined the Beat Generation. It is a largely autobiographical work that is based on the spontaneous road trips of Kerouac and his friends across mid-century America.", 'inventory_count': 70, 'isbn': '9780140283297', 'author_id': '040669fa-5a20-4c57-bd98-06e9f7a358db', 'book_id': '755dcd0e-9ed8-4879-8f69-9474e246d7ed'},
    ...
    {'book_title': 'The Unbearable Lightness of Being', 'page_count': 314, 'publish_date': '1984-01-01', 'price': 18.0, 'short_description': 'Milan Kundera�s novel of love and politics in Communist-era Prague explores the lives and loves of a small group of characters, interweaving their personal stories with philosophical musings on existence.', 'inventory_count': 70, 'isbn': '9780060932138', 'author_id': '29f6e97e-b42a-4e6d-9b0e-2dc8e601eb51', 'book_id': '144c7663-377a-42b2-a074-578a1e32cb8d'},
    ...
    {'book_title': 'The Tale of Genji', 'page_count': 1176, 'publish_date': '1001-01-01', 'price': 25.0, 'short_description': "Written in the 11th century by Murasaki Shikibu, a lady in the Heian court of Japan, The Tale of Genji is considered the world's first novel, offering a richly detailed portrait of courtly life in medieval Japan.", 'inventory_count': 50, 'isbn': '9780679417385', 'author_id': 'bd610b47-b38c-4928-87f7-038048156b1b', 'book_id': '4d4915f8-ef78-482b-a865-7f31ab798c9a'},
    {'book_title': 'A Room with a View', 'page_count': 256, 'publish_date': '1908-01-01', 'price': 12.0, 'short_description': "E.M. Forster's beloved novel is a social critique and comedy of manners set in Edwardian England, following the romantic travails of a young woman, Lucy Honeychurch.", 'inventory_count': 75, 'isbn': '9780141183297', 'author_id': '8ac0cd63-3c60-4e7e-b39a-665011161c68', 'book_id': '92bbd1f2-069b-4828-bd02-6f6afe3de195'},
    {'book_title': 'The End of the Affair', 'page_count': 160, 'publish_date': '1951-01-01', 'price': 14.95, 'short_description': 'Set in London during and just after the Second World War, the novel revolves around the relationships between Maurice Bendrix and Sarah Miles, and explores themes of love, obsession, and faith.', 'inventory_count': 85, 'isbn': '9780141441122', 'author_id': '549c2c00-904a-406f-a9b3-45897b39005f', 'book_id': 'f6634faa-4159-41a0-9d6e-20f3d51a27f7'},
    ...
    {'book_title': 'Blindness', 'page_count': 352, 'publish_date': '1995-01-01', 'price': 16.0, 'short_description': 'A powerful allegorical novel by Jos� Saramago about a society suffering an epidemic of blindness that reveals both the dignity and depravity of humanity.', 'inventory_count': 75, 'isbn': '9780156007757', 'author_id': '2e42da73-e564-4c84-88a6-74109563c342', 'book_id': '9b5427ed-badb-4e4e-82f3-478ab7d8e0c4'},
    {'book_title': 'If This Is a Man', 'page_count': 400, 'publish_date': '1947-01-01', 'price': 14.95, 'short_description': "Primo Levi's memoir of his year spent in Auschwitz is a lucid and sober account of the everyday realities of life in the Holocaust, offering insight into the human condition under the most extreme circumstances.", 'inventory_count': 60, 'isbn': '9780349100135', 'author_id': '816c5d26-a35f-4746-bafa-5765da151ba8', 'book_id': 'fabe6dd1-fa38-457c-9f9d-6676ef7002d6'},
    ...
    {'book_title': 'White Teeth', 'page_count': 448, 'publish_date': '2000-01-01', 'price': 14.0, 'short_description': "Zadie Smith's acclaimed debut novel is a vibrant, multigenerational story about two families in London, exploring Britain's relationship with people from formerly colonized countries in Africa, Asia, and the Caribbean.", 'inventory_count': 85, 'isbn': '9780375703867', 'author_id': 'e5b3b407-d66e-430e-bc05-8e74bdfea0a7', 'book_id': '66eece62-7a93-46a3-85c4-4ba15e646bd0'},
    ...
    {'book_title': 'The Underground Railroad', 'page_count': 320, 'publish_date': '2016-08-02', 'price': 16.95, 'short_description': "Colson Whitehead's Pulitzer Prize-winning novel is a magnificent, harrowing account of Cora, a slave on a cotton plantation in Georgia, and her journey to freedom via a secret network of tracks and tunnels beneath the Southern soil.", 'inventory_count': 75, 'isbn': '9780385542364', 'author_id': '21ce8037-6c63-4a1e-9a4a-7300d12ff77d', 'book_id': '88814018-1039-4f93-aeac-dda2e321b287'},
    {'book_title': 'Nausea', 'page_count': 178, 'publish_date': '1938-01-01', 'price': 15.95, 'short_description': "Jean-Paul Sartre's philosophical novel that introduces the concept of existentialism through the experience of its protagonist, Antoine Roquentin, who confronts the absurdity of existence.", 'inventory_count': 90, 'isbn': '9780811220309', 'author_id': '703688cc-7bd1-4f94-bbf2-fb77519301b8', 'book_id': '6201dafd-9788-4181-9eea-20719a9653df'},
    ...
    {'book_title': 'The Talented Mr. Ripley', 'page_count': 272, 'publish_date': '1955-01-01', 'price': 14.0, 'short_description': "Patricia Highsmith's psychological thriller introduces Tom Ripley, a young striver newly arrived in the heady world of Manhattan, who becomes entangled in a complex web of deceit.", 'inventory_count': 75, 'isbn': '9780393332148', 'author_id': '388a8a87-65ea-4e60-ad1b-2e2fc6131f44', 'book_id': 'cac758ad-3381-4182-a6ea-0022b083495a'},
    ...
    {'book_title': 'Angels & Demons', 'page_count': 736, 'publish_date': '2000-04-01', 'price': 10.99, 'short_description': 'In this thrilling novel by Dan Brown, Harvard symbologist Robert Langdon is summoned to a Swiss research facility to analyze a mysterious symbol seared into the chest of a murdered physicist. What follows is a breathtaking adventure that takes Langdon deep into the ancient world of the Illuminati, a legendary secret society with a history of violence and conspiracy.', 'inventory_count': 55, 'isbn': '9780671027360', 'author_id': '40134642-8951-49b0-8a4c-6772c4b421dd', 'book_id': 'dca253be-4e17-4028-ab11-85fb94f33e98'},
